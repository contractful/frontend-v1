...
import { Security, AccountBalanceWallet, Brush } from '@material-ui/icons';
    ...
    <main>
        ...
        <Grid container>
          ...
          <Grid item xs={4}>
            <FormControl fullWidth>
              <InputLabel id="engagement-length-select-label">Length of engagement</InputLabel>
              <Select
          ...
          <Grid item xs={4}>
            <FormControl fullWidth>
              <InputLabel id="engagement-begins-select-label">Engagement begins</InputLabel>
              <Select
      ...
      <Container maxWidth="md">
        <Grid container>
          ...
          <Grid item xs={8}>
            <FormControl fullWidth>
              <InputLabel id="engagement-type-select-label">Type of engagement</InputLabel>
              <Select
          ...
          <Grid item xs={8}>
            <FormControl fullWidth>
              ...
              <Select
                ...
                label="Payment terms"
              >
                <MenuItem value={2}>2 weeks (with successful sprint review)</MenuItem>
              </Select>
            </FormControl>
          </Grid>
        </Grid>
