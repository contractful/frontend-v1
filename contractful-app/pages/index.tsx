...
const handleClick = (e: React.MouseEvent<HTMLElement>, targetUrl: string) => {
  e.preventDefault();
      ...
      <IntroBg>
          ...
          <Grid container pt={8}>
            <Grid item xs={8}>
              ...
              <Typography variant="h3" pt={1}>
                Peer-2-peer safe and secure Hiring Agreements for everyone to
                use.
              </Typography>
            </Grid>
            <Grid item></Grid>
              ...
              <Stack direction="column" spacing={4} pt={4}>
                <Stack direction="row" spacing={4}>
                  ...
                  >
                    ...
                    >
                      The Agreement is powered by a Smart Contract that works as
                      an escrow to the hiring budget.
                    </Typography>
                  </Paper>
                  <Paper
                    elevation={0}
                ...
                <Stack direction="row" spacing={4}>
                  ...
                  >
                    ...
                    >
                      Fair, safe and secure on-chain automated payment
                      processing.
                    </Typography>
                  </Paper>
                  <Paper
                  ...
                  >
                    ...
                    />
                    <Typography variant="h6">Full budget control.</Typography>
                    <Typography
                      sx={{
                        color: "#666",
                        fontSize: "smaller",
                    ...
                    >
                      The Agreement ensures clean budget planning that matches
        ...
        <Container>
          <Typography variant="h5">
            <ol>
              <li style={{ paddingBottom: 32 }}>
                Build your team: Come up with individual Agreements (off-chain).
              </li>
              <li style={{ paddingBottom: 32 }}>
                Formulate all details of the Agreement and use contractful to
                deploy them on-chain.
              </li>
              <li style={{ paddingBottom: 32 }}>
                Manage budget and payments automatically for a long-term
            ...
            <Stack>
              ...
              >
                ...
                <Typography px={4} pt={1}>
                  <b>As a client:</b> Ready to use contractful to create a
                  Hiring Agreement.
                </Typography>
                <Box
                  pt={1}
          ...
          <Grid item xs p={4}>
            <Stack>
              ...
              >
                ...
                <Typography px={4} pt={1}>
                  <b>As a service provider:</b> Review and consent to an
                  Agreement prepared for you.
                </Typography>
                <Box
                  pt={1}
                  px={4}
